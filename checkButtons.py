...
class Checkbox:
    def __init__(self, surface, dim=(18,18), pos=(0,0), caption="", color=(255, 255, 255), outline_color=(0, 0, 0),
        ...
        self.dim_y = dim[1]
        # checkbox object
        self.checkbox_obj = pg.Rect(self.x, self.y, self.dim_x, self.dim_y)
    ...
    def _draw_button_text(self):
        ...
        self.font_pos = (self.x + self.dim_x * 2 - w / 2 + self.to[0], self.y + self.dim_y / 2 - h / 2 + self.to[1])
    ...
    def render_checkbox(self):
        if self.checked:
            ...
            pg.draw.circle(self.surface, self.cc, (self.x + self.dim_x / 2, self.y + self.dim_y / 2), (self.dim_x - 6) / 2)
